...
// Add a new property to superhero

superhero.speed = 'agile';

const {name, secretName, sidekick, strength, speed} = superhero;

console.log(name, secretName, sidekick, strength, speed)
